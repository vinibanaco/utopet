...
?>
	...
	<title>Animais para Adoção | UtoPet - Encontre seu Bichinho</title>

<?php require ("header.php"); ?>

	<main id="main" class="main-adocao">
		<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ SIDEBAR ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
		...
		<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ CONTEÚDO ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
		<section class="img-destaque img-destaque-adocao">
			<h2>Animais para Adoção</h2>

			<a class="btn-cadastrar-animal" href="cadastrar-adocao.php">
				<img src="icons/plus.png" alt="" title="Publique um animal">
			</a>
		</section>

		<section class="descricao">
			<p>Se você deseja adotar um animal de rua, procure aqui e entre em contato com a pessoa que o está divulgando. Preencha o filtro com as características do animal para facilitar na busca.</p>
			...
			<p>Não encontrou o dono e deseja doar o animal? <a href="cadastrar-adocao.php">Publique-o</a></p>
		</section>
		...
		<div class="resultados">
			<?php
				...
				if ($caracteristicas == "") {
					$queryDadosAnimais = "SELECT codigo_ani, codigo_usu, nome_foto_ani, especie_ani, sexo_ani, porte_ani, cor_ani, pelagem_ani, data_ani, nome_ani, informacoes_ani FROM animais WHERE estado_ani = 'adocao' ORDER BY data_ani desc";
				} else {
					$queryDadosAnimais = "SELECT codigo_ani, codigo_usu, nome_foto_ani, especie_ani, sexo_ani, porte_ani, cor_ani, pelagem_ani, data_ani, nome_ani, informacoes_ani FROM animais WHERE estado_ani = 'adocao' $caracteristicas ORDER BY data_ani desc";
				}
