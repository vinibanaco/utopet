...
if (!isset($_SESSION['codigo_usu'])) {
	...
	<script>
		...
		window.location.href = 'encontrados.php';
	</script>";
} else {
	require ("head.php");
?>

		<title>Cadastrar Animal Encontrado | UtoPet - Encontre seu Bichinho</title>
	...
	<?php require ("header.php"); ?>
		...
		<main id="main" class="main-cadastrar-animal">
			<section class="cadastro">
				<h2>Cadastrar Animal Encontrado</h2>
			
				<form action="upload.php?estado_ani=encontrado" enctype="multipart/form-data" method="post">
