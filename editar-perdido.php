	...
	<?php require ("header.php"); ?>
		...
		<main id="main" class="main-cadastrar-animal">
			<section class="cadastro">
				...
				<form action="update.php?codigo=<?= $codigo_usu ?>&estado_ani=perdido" enctype="multipart/form-data" method="post">
		...
		<script>
			...
			function excluir() {
				confirmar(
					...
					function () {
						window.location.href = "excluir-animal.php?estado=perdido&codigo=" + <?= $codigo_ani ?>;
					}
				)  
			}
		</script>
