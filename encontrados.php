...
?>
	...
	<title>Animais Encontrados | UtoPet - Encontre seu Bichinho</title>

<?php require ("header.php"); ?>

	<main id="main" class="main-encontrados">
		<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ SIDEBAR ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
		...
		<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ CONTEÚDO ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
		<section class="img-destaque img-destaque-encontrados">
			<h2>Animais Encontrados</h2>

			<a class="btn-cadastrar-animal" href="cadastrar-encontrado.php">
				<img src="icons/plus.png" alt="" title="Publique um animal">
			</a>
		</section>

		<section class="descricao">
			<p>Se você perdeu o seu bichinho, procure aqui para ver se outra pessoa o encontrou. Preencha o filtro com as características do seu animal para facilitar na busca.</p>
			...
			<p>Encontrou algum animal na rua? <a href="cadastrar-encontrado.php">Publique-o</a></p>
		</section>
		...
		<div class="resultados">
			<?php
				...
				$queryDadosAnimais = "SELECT codigo_ani, codigo_usu, nome_foto_ani, especie_ani, sexo_ani, porte_ani, cor_ani, pelagem_ani, data_ani, nome_ani, informacoes_ani FROM animais WHERE estado_ani = 'encontrado' $caracteristicas ORDER BY data_ani desc";
						...
						<div class="popup">
							...
							<div class="dados-popup">
								...
								<div class="popup-dados-animal">
									...
									<?php if ($resultadosAnimais['codigo_usu'] == $_SESSION['codigo_usu']) { ?>
